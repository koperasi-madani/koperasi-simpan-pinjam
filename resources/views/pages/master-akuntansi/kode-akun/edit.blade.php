        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                            <form action="{{ route('kode-akun.update',$data->id) }}" method="POST">
                            @method('put')
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input placeholder="Masukkan nama kode" type="text" value="{{ old('nama',$data->kode_induk) }}" readonly class="form-control @error('nama') is-invalid @enderror" name="nama" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        <label for="product_name" class="form-label">Kode Akun</label>
                                        <input placeholder="Masukkan kode" value="{{ old('kode',$data->kode_akun) }}" readonly type="text" value="{{ old('kode',$data->kode_akun) }}" readonly class="form-control @error('kode') is-invalid @enderror" name="kode" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-4">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input placeholder="Masukkan nama kode" type="text" value="{{ old('nama',$data->nama_akun) }}" class="form-control @error('nama') is-invalid @enderror" name="nama" />
                                        @error('nama')
                                            <div class="invalid-feedback">
                                                {{$message}}.
                                            </div>
