    ...
    <section class="content-main">
        ...
        <div class="row">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('kode-ledger.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <label for="product_name" class="form-label">Kode Ledger</label>
                                    <input placeholder="Masukkan kode ledger" value="{{ old('kode_ledger') }}" type="text" value="{{ old('kode_ledger') }}" class="form-control @error('kode_ledger') is-invalid @enderror" name="kode_ledger" />
                                    @error('kode_ledger')
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start">
                                                    <div class="mx-2">
                                                        <a href="{{ route('kode-ledger.edit',$item->id) }}" class="btn btn-sm font-sm rounded btn-brand"> <i class="material-icons md-edit"></i> Edit </a>
                                                    </div>
                                                    <form action="{{ route('kode-ledger.destroy',$item->id) }}" class="p-0 m-0" method="POST" onsubmit="return confirm('Move data to trash? ')">
                                                        @method('delete')
                                                        @csrf
