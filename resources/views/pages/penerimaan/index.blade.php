                ...
                <div class="card card-body mb-4">
                    ...
                    <article class="icontext">
                        ...
                        <div class="text">
                            ...
                            <input type="number" name="pembayaran" id="pembayaran" value="{{ isset($pembayaran) ? $pembayaran - $nominal_denominasi : 0 }}" hidden>
                            <span>Rp. {{ number_format(isset($pembayaran) ? $pembayaran - $nominal_denominasi : 0 ,2, ",", ".") }}</span>
                        </div>
                    </article>
                    <hr>
