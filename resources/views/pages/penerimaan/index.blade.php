                ...
                <div class="card card-body mb-4">
                    <article class="icontext">
                        ...
                        <div class="text">
                            ...
                            <input type="number" name="pembayaran" id="pembayaran" value="{{ $pembayaran != 0 ? $pembayaran->penerimaan : 0 }}" hidden>
                            <span>Rp. {{ number_format($pembayaran != 0 ? $pembayaran->penerimaan : 0 ,2, ",", ".") }}</span>
                        </div>
                    </article>
                    <hr>
