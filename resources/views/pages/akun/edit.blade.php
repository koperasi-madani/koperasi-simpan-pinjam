        ...
        <script>
           $(document).ready(function(){
                ...
                $("#toggleDua").change(function(){
                    ...
                    if($(this).is(':checked')){
                    // Changing type attribute
                        $("#passwordDua").attr("type","text");

                        // Change the Text
                        $("#toggleTextDua").text("Hide");
                        }else{
                        // Changing type attribute
                        $("#passwordDua").attr("type","password");
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-4">
                                        ...
                                        <input placeholder="Masukkan Nama Akun" type="text" value="{{ old('nama',$data->name) }}" class="form-control @error('nama') is-invalid @enderror" name="nama" />
                                        @error('nama')
                                ...
                                <div class="col-md-12">
                                    <div class="mb-4">
                                        ...
                                        <input placeholder="Masukkan Username" type="text" value="{{ old('username',$data->username) }}" class="form-control @error('username') is-invalid @enderror" name="username" />
                                        @error('username')
                                            <div class="invalid-feedback">
                                                {{$message}}.
                                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-4">
                                        ...
                                        <input placeholder="Masukkan Email" type="email" value="{{ old('email',$data->email) }}" class="form-control @error('email') is-invalid @enderror" name="email" />
                                        @error('email')
                                            <div class="invalid-feedback">
                                                {{$message}}.
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex flex-row">
                                            <div class="w-75">
                                                <input placeholder="Masukkan Password" type="password" style="height: 41px" type="text" id="passwordDua" value="{{ old('password') }}" class="form-control @error('password') is-invalid @enderror" name="password" />
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex flex-row">
                                            <div class="w-75">
                                                <input placeholder="Masukkan Ulangi Password" style="height: 41px" type="password" id="password" value="{{ old('password_confirmation') }}" class="form-control @error('password_confirmation') is-invalid @enderror" name="password_confirmation" />
                                            </div>
                                            <div class="align-self-center mx-2">
                                                <label for="">
