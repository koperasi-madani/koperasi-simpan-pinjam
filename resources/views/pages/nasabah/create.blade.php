                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-4">
                                        ...
                                        <input placeholder="No Anggota" value="{{ $noAnggota }}" type="text" value="{{ old('no_anggota') }}" class="form-control @error('no_anggota') is-invalid @enderror" name="no_anggota" />
                                        @error('no_anggota')
                                            <div class="invalid-feedback">
                                                {{$message}}.
                                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-4">
                                        ...
                                        <input placeholder="Masukkan Nama Anggota" type="text" value="{{ old('nama') }}" class="form-control @error('nama') is-invalid @enderror" name="nama" />
                                        @error('nama')
                                            <div class="invalid-feedback">
                                                {{$message}}.
                                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-4">
                                        ...
                                        <input placeholder="Masukkan NIK Anggota" type="text" value="{{ old('nik') }}" class="form-control @error('nik') is-invalid @enderror" name="nik" />
                                        @error('nik')
                                            <div class="invalid-feedback">
                                                {{$message}}.
                                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            ...
                            <input type="text" id="simpanan_pokok" value="{{ old('simpanan_pokok') }}" placeholder="Masukkan simpanan pokok" class="form-control @error('simpanan_pokok') is-invalid @enderror" name="simpanan_pokok"/>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="simpanan_wajib" value="{{ old('simpanan_wajib') }}" placeholder="Masukkan simpanan wajib" class="form-control @error('simpanan_wajib') is-invalid @enderror" name="simpanan_wajib"/>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="simpanan_sukarela" value="{{ old('simpanan_sukarela') }}" placeholder="Masukkan simpanan sukarela" class="form-control @error('simpanan_sukarela') is-invalid @enderror" name="simpanan_sukarela"/>
